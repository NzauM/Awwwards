...
class ProfileTEst(TestCase):
    def setUp(Self):
        ...
        self.mercy = Profile(user = Self.mercy,user_id = 1,bio = 'Web design',profile_pic = 'pic.jpg',info = 'Contact me')
...
class ProjectsTestCase(TestCase):
    def setUp(self):
        ...
        '''
        self.new_post = Projects(image = 'pic.jpg',title = 'picture',description = 'Nice picture',user = mercy,link = 'https://trial.com')
...
class CommentTestCase(TestCase):
    def setUp(self):
        self.comment=Comment(text="So Nice",project_id=self.bmw.id,user = self.mercy')    
